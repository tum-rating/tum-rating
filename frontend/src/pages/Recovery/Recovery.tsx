                ...
                {!token ? (
                    ...
                    <Box maw={300}>
                        ...
                        <Container p={0} size={600} mb="xl">
                            <Text c="dimmed" ta="center" fz="15">
                                Good news – your password has been recovered! You can now log in to your account using
                                your new credentials.
                            </Text>
                        </Container>

                        <Button mt={10} fullWidth variant="gradient" gradient={{from: 'indigo', to: 'blue', deg: 90}}
                                className={classes.control} onClick={() => navigate('/#modal=sign-in')}>
                            Log In
                        </Button>
                    </Box>
                ) : (
                    <Box maw={300}>
                        ...
                        <Container p={0} size={600} mb="xl">
                            <Text c="dimmed" ta="center" fz="sm">
                                You are just a step aw ay from resetting your password. Please enter your new password
                        ...
                        >
                            ...
                            <Stack>
                                <PasswordInput autoFocus data-autofocus data-testid="password" autoComplete="on"
                                               required label="Password" placeholder="Password"
                                               value={form.values.password}
                                               onChange={(event) => form.setFieldValue('password', event.currentTarget.value)}
                                               error={form.errors.password}/>
                                <PasswordInput data-testid="confirm-password" autoComplete="on" required
                                ...
                                <Button mt={10} fullWidth variant="gradient"
                                        gradient={{from: 'indigo', to: 'blue', deg: 90}} type="submit">
                                    Reset Password
                                </Button>
                            </Stack>
                        </form>
