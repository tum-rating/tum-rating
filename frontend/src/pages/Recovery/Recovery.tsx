        ...
        <Stack mx="auto" align="center" justify="center" className={classes.wrapper}>
            {!token ? (
                ...
                <Box maw={300}>
                    ...
                    <Container p={0} size={600}>
                        <Text c="dimmed" fz="md" ta="center">
                            Good news – your password has been recovered! You can now log in to your account using your
                            new credentials.
                        </Text>
                    </Container>
                ...
                <Box maw={300}>
                    ...
                    <Container p={0} size={600}>
                        <Text c="dimmed" fz="md" ta="center">
                            You are just a step away from resetting your password. Please enter your new password below
                    ...
                    >
                        ...
                        <Stack>
                            ...
                            <PasswordInput data-testid="cypress-login-confirm-password-input" autoComplete="on" required
