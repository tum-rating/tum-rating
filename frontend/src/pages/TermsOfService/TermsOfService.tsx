    ...
    return (
        <PageWrapper>
            <Box p="xl" className='children-animation'>
                ...
                <p>These Terms of service outline the rules and regulations for the use of tum-rating's Website,
                    located at {WEBSITE_URL}.</p>

                <p>By accessing this website we assume you accept these Terms of service. Do not continue to use
                    tum-rating if you do not agree to take all of the Terms of service stated on this page.</p>

                <p>The following terminology applies to these Terms of service, Privacy Statement and Disclaimer
                    Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website
                    and compliant to the Company's Terms of service. "The Company", "Ourselves", "We", "Our" and
                    ...
                    with and subject to, prevailing law of de. Any use of the above terminology or other words in the
                ...
                <p>We employ the use of cookies. By accessing tum-rating, you agreed to use cookies in agreement with
                    the tum-rating's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, tum-rating and/or its licensors own the intellectual property rights for all
                    material on tum-rating. All intellectual property rights are reserved. You may access this from
                    tum-rating for your own personal use subjected to restrictions set in these terms and
                    conditions.</p>
                ...
                <p>This Agreement shall begin on the date hereof. Our Terms of service were created with the help of
                    the <a href="https://www.termsandconditionsgenerator.com/">Free Terms of service Generator</a>.
                </p>

                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. tum-rating does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of tum-rating,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                    and opinions. To the extent permitted by applicable laws, tum-rating shall not be liable for the
                ...
                <p>tum-rating reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant tum-rating a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of tum-rating; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to tum-rating. Please include your name, your
                ...
                <p>No use of tum-rating's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
                ...
                <p>We reserve the right to request that you remove all links or any particular link to our Website. You
                    ...
                    amen these Terms of service and it's linking policy at any time. By continuously linking to our
                    Website, you agree to be bound to and follow these linking Terms of service.</p>
