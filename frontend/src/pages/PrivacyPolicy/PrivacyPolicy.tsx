        ...
        <PageWrapper>
            ...
            <Box p="xl" className="children-animation">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to {COMPANY_NAME}, accessible from{' '}
                            <a href={WEBSITE_URL} rel="external nofollow noopener noreferrer" target="_blank">
                                {WEBSITE_URL}
                            </a>
                        </p>
                    </li>
                ...
                <ul>
                    <li>
                        ...
                        <a href={CONTACT_PAGE_URL} rel="external nofollow noopener noreferrer" target="_blank">
                            {CONTACT_PAGE_URL}
                        </a>
                    </li>
                </ul>
