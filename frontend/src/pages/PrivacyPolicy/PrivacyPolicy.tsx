...
import {
    ...
    LAST_UPDATED_DATE,
    WEBSITE_URL
} from "@/pages/PrivacyPolicy/constans.ts";
        ...
        <PageWrapper>
            <Box p="xl" className='children-animation'>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to {COMPANY_NAME}, accessible from <a
                            href={WEBSITE_URL} rel="external nofollow noopener"
                            target="_blank">{WEBSITE_URL}</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By visiting this page on our website: <a href={CONTACT_PAGE_URL}
                                                                 rel="external nofollow noopener noreferrer"
                                                                 target="_blank">{CONTACT_PAGE_URL}</a></li>
                </ul>
            </Box>
        </PageWrapper>
    );
