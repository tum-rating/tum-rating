            ...
            <div className={classes.inner}>
                ...
                <Container p={0} size={600}>
                    <Text size="lg" color="dimmed" className={classes.description}>
                        Congratulations! Your account is now activated. You can log in and start exploring and enjoying our platform's features. You are now able to search for courses and even add your own reviews to share your experience with others.
                    </Text>
                </Container>
