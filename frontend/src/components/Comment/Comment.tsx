...
export const Comment = (props: CommentProps) => {
    ...
    return (
        <Flex p="md" data-comment={userCommentFlag ? 'user-comment' : 'comment'} direction="column"
                    ...
                    <Flex gap="xs">
                        ...
                        <Flex direction="column">
                            <Flex w="100%" align="center">
                                <Text maw={userCommentFlag ? "50vw" : "75vw"} truncate size="sm"
                                      fw="500">{userName}{' '}</Text>
                                {userCommentFlag && (
                    ...
                    <Menu position="bottom-end">
                        ...
                        <Menu.Dropdown>
                            {userCommentFlag ? (
                                ...
                                <Menu.Item><Text c="red" size="sm">Report</Text></Menu.Item>
                            )}
                        </Menu.Dropdown>
                    </Menu>
                </Flex>
