import { Alert, BackgroundImage, Button, Center, Container, LoadingOverlay, Select, Stack, Text, TextInput } from '@mantine/core';
    ...
    return (
        <Container p={0} data-testid="cypress-add-new-course-modal">
            ...
            <form onSubmit={form.onSubmit((e) => handleSubmit(e))}>
                <Stack>
                    <TextInput data-testid="cypress-add-new-course-name-input" required label="Course name" placeholder="Course name" value={form.values.name} onChange={(event) => form.setFieldValue('name', event.currentTarget.value)} radius="md" />
                    ...
                    <Button loading={addReviewLoading} mt="xs" type="submit" variant="gradient" gradient={{ from: 'indigo', to: 'blue', deg: 90 }}>
                        Add Course Proposal
                    </Button>
                    <BackgroundImage src="https://raw.githubusercontent.com/mantinedev/mantine/master/.demo/images/bg-6.png" radius="md" pos="relative">
                        <Center p="md">
