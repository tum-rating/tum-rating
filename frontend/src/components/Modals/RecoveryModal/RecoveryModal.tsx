        ...
        <Box h="100%">
            ...
            <form className="modal-form" onSubmit={form.onSubmit((e) => handleSubmit(e))}>
                ...
                {isRecoverySuccess ? (
                    ...
                    <Stack p="sm">
                        <TextInput autoFocus data-autofocus leftSection={<IconAt size="1.1rem"/>} data-testid="email"
                                   required label="Email" placeholder="Email"
                        ...
                        <Button data-testid="submit" variant="gradient" gradient={{from: 'indigo', to: 'blue', deg: 90}}
                                type="submit">
                            Send recovery email
                        </Button>
                    </Stack>
