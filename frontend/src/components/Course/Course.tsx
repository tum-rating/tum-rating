            ...
            {isError ? <Box h="calc(100vh - 69px)">
                <Center h="100%">
                    <Flex justify="center" align="center" direction="column" gap="xs">
                        ...
                        <Text c="dimmed" fw="500">This content doesn't exist</Text>
                    ...
                    <Box className={classes.courseContent}>
                        <Flex className={clsx(classes.courseBanner, "children-animation")}>
                            <Box className={classes.image}>
                                <Skeleton radius="lg" mah={90} w={280} h={100} loading={isLoading} component={
                                    <Image radius="lg" h={100} mah={90} w={280} fit="contain"
                            ...
                            <Flex className={classes.courseDetails} direction="column" gap="xs">
                                <Skeleton h={37} width={300} radius="lg" loading={isLoading} component={
                                    <Text style={{wordBreak: "break-word"}} fz={24} fw="700" lineClamp={5}>
                                        {data?.course}{' '}
                                    </Text>
                                }/>
                                <Flex gap="xs">
                                    <Skeleton w={180} h={26} radius="lg" loading={isLoading} component={
                                        <Badge
