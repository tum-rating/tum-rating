                            ...
                            <Flex className={classes.courseDetails} direction="column" gap="xs">
                                ...
                                <Flex gap="xs">
                                    <Skeleton
                                        ...
                                        loading={isLoading}
                                        component={
                                            <Badge leftSection={<IconAlien width={16} />} autoContrast variant="light" onClick={() => navigate(`/?search=${data.professor}`)} size="lg">
                                                {data?.professor}{' '}
                                            </Badge>
                                        }
                                    />
                                    {data?.offeredInSemesters.map((semester) => (
                                        <Badge leftSection={<IconCalendarMonth width={16} />} autoContrast variant="light" color="lime.9" size="lg">
                                            {semester}{' '}
                                        </Badge>
                                    ))}
                                </Flex>
