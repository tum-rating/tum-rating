    ...
    return (
        ...
        >
            <Stack>
                ...
                <Textarea {...form.getInputProps('description')} required placeholder="Description" label={'Description'} />
                <Switch
                ...
                />
                {error && (
                    <Alert data-testid="error-message" variant="light" color="red" title="Error" icon={<IconFaceIdError />}>
