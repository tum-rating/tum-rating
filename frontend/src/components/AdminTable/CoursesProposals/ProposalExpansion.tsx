            ...
            {isError ? (
                    ...
                    <Flex justify="flex-start" gap="xs" wrap="wrap">
                        ...
                        <Flex align="center" gap="3">
                            ...
                            <Skeleton
                                ...
                                loading={isLoading}
                                component={
                                    <Text truncate fz="xs" fw="600" c="dimmed">{courseProposalDetails?.courseId}</Text>
                                }>
                            </Skeleton>
                        </Flex>
                    </Flex>
                ...
                <Flex direction="column" gap="xs" className={classes.expansionActions}>
                    ...
                    <Stack gap="xs">
                        ...
                        }} leftSection={<IconCircleCheck width={16}/>} color="green">Accept Proposal</Button>
                        <Button onClick={() => {
                            removeProposal(proposal._id)
                        }} leftSection={<IconTrashX width={16}/>} color="red">Remove Proposal</Button>
