import {Autocomplete, Button, Divider, Flex, Pill, PillsInput, Stack, Text, TextInput} from "@mantine/core";
...
const UserExpansion = ({user: IProposal, editing: IEditing}: UserExpansionProps) => {
