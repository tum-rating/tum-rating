export const configuration = {
    ...
    clients: [
        {
            ...
            redirect_uris: ['http://localhost:5174/oauth/redirect', 'http://localhost:3000/oauth/redirect'],
        },
    ],
    claims: {
    ...
    ttl: {
        AccessToken: (ctx, token) => {
          // Define a custom expiration time in seconds (e.g., 1 hour = 3600 seconds)
          return 3600000; // 1 hour TTL
        },
        // Optionally, you can define TTL for other token types here
        RefreshToken: (ctx, token) => 86400, // 1 day TTL
    },
};
