        ...
        return (
            <div
                className={cn(
                    ...
                    "has-[:focus-visible]:outline-none has-[:focus-visible]:ring-1 has-[:focus-visible]:ring-ring has-[:focus-visible]:ring-offset-2 dark:has-[:focus-visible]:ring-neutral-300" +
